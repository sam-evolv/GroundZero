...
headline: Discovery pending for a proposed Here’s Health Digital Platform spanning Square café ordering and Shopify retail.
valid: true
...
## Verified from Sam’s supplied brief

- Conor’s original request is a Square-connected café ordering, payment and collection app for a new café.
- Sam intends to propose a wider Here’s Health brand app with Home, Café, Shop, Rewards and Account.
- Here’s Health currently operates Shopify retail and Square-backed café systems.
- Conor is expected to provide information and access after the introduction.
- Internal target is a production-ready candidate in six weeks, with a further two-week release buffer.

## Not yet verified

- No Square or Shopify access has been inspected.
...
- No Apple or Google organisation account readiness has been confirmed.
- No exact budget, signed scope, support agreement or acceptance owner is recorded.
- The expanded whole-brand platform is Sam’s recommended commercial direction, not a recorded client decision.
...
- Sauna booking beyond a safe existing-service link or verified integration.
- Broad AI and automation features.

## Immediate dependencies

- Conor’s email and available documentation.
- Secure Shopify and Square access.
- Named staff contact for café operations and hardware walkthrough.
- Brand assets, photography and legal policies.
- Agreement on scope, price, support and acceptance responsibilities.
