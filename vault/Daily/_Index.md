...
purpose: chronological index of all daily sync/run notes
kind: moc
---

# Daily Notes Index

| Date | Heartbeat | Key items created/updated |
|---|---|---|
...
Each daily note is created by the 6am Dublin council run. It captures:
- what was checked (GitHub PRs, issues, Vercel, Supabase)
- what new items were proposed
