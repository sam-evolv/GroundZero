---
name: Ground Zero Context Index
purpose: Shared entry point for all models
---

# Ground Zero Context Index
...
- **goals/**: long-lived goals and target outcomes
- **items/**: active work items and tactical tasks
...
- [[context/linkedin-network]] — current 832-connection LinkedIn relationship graph, provenance and network-use rules
...
- [[briefs/2026-08-10-physical-world-intelligence-founder-debrief]] — founder thesis for an asset-centric, time-aware intelligence layer over imagery, documents and repeated physical-world observations
...
- [[briefs/2026-08-05-personal-assistant-prototype-start-gate]] — minimum repository, scope, safety, data and exercised-path conditions required before prototype implementation
...
- Claude access observations: [[context/claude-access-observed]]
- Ground Zero structure: [[context/ground-zero-structure]]
- Ground Zero capture workflow: [[context/capture-workflow]]
