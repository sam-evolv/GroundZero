---
title: Business Opportunities Map
purpose: MOC hub for all wedge/opportunity briefs and cross-cutting themes
kind: moc
---

# Business Opportunities MOC

This is the map of all explored business wedges, cross-cutting opportunity briefs, and the companies or items they connect to.

## By vertical

### Energy & Solar
- [[briefs/solar-installer-software-wedge]] — software layer for solar installers (not an install company)
...
- [[briefs/2026-08-12-irish-decision-simulation-opportunity]] — Irish decision-simulation opportunity, evidence boundary, method map and first falsifiable homeowner pilot
...
Planet.com data is not a single-wedge opportunity. It touches multiple businesses:

| Use case | Feed into | Why |
|---|---|---|
| Solar farm construction monitoring | [[items/renew-grid-automation]] | verify export capacity vs build progress |
| Roof condition change detection | [[companies/openhouse-ai]] | post-handover evidence of defects/drainage |
| Venue site/facility monitoring | [[companies/openbook]] | car park utilization, signage changes |
| General construction progress | [[context/consulting-wedges]] | evidence layer for developer clients |
...
- [[context/capture-workflow]] — new sources arrive here, then get turned into briefs
- [[items/_Index]] — active items derived from these opportunities
- [[context/scaling-playbook]] — how to turn a pattern into a portfolio
