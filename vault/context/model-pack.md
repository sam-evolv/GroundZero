...
- Local Aire/Hermes compatibility branches `944a03e` and `1004f3e` remain unpushed, unintegrated and without independent or physical acceptance; they do not supersede `83e582c` or close the Profile and Work gaps. The installed Hermes checkout remains clean at upstream `fdf6f1d4`, and the supervised gateway started after that commit at 20:42 IST on 19 August; this corrects the earlier process-age observation but does not show compatibility branch `1004f3e` is loaded. Current upstream `main` is `f43eabee`, 314 commits beyond the running installation and 1,355 commits beyond compatibility base `f0c222c`, with the latest verified range materially changing relay and scheduled-message continuity/formatting, group clarification and approval visibility, keyless rescue policy handling, process identity, long-running turn limits, source-preserving Desktop updates and gateway restart recovery. This is operational and integration-review input, not Aire progress or physical acceptance.
