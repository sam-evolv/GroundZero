...
domain: growth
title: Reusable developer discovery-to-proposal pack for warm intros
rationale: Warm developer introductions (Bridgewater, five schemes) arrive faster than they can be converted, because each proposal is written from scratch. A reusable pack turns a warm intro into a tailored one-page proposal within a day.
...
## Market timing
Timely. The Bridgewater introduction is being prepared now, so the pack is most useful in the immediate window before that first developer proposal is needed.

## Connects to
- [[items/oh-bridgewater-warm-introduction]] — live test case and first consumer
