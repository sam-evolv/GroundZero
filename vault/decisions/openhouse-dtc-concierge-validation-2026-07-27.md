---
title: OpenHouse DTC concierge validation
company_id: openhouse-ai
date: 2026-07-27
status: active-decision
---

# OpenHouse DTC concierge validation
...
- DTC removes developer access as a prerequisite and expands OpenHouse to existing homes.
- Consumers still require a high-intent reason to pay and provide home context.
- A BER, bill, survey or quote supplies both the trigger and the first evidence.
- Project-pass economics can fund acquisition better than an unproven low-price subscription.
- The Home Record, evidence graph and recurring workflows create differentiation from generic chat.
- Developer distribution remains valuable because it creates a verified record at handover with lower consumer effort.
...
- No universal savings, automation or supported-device claim is permitted.
- No production deployment, migration, paid acquisition or vendor contract follows from this decision without separate approval.
