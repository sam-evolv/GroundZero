...
**Commercial focus, 2026-08-04:** The site and verified Longview developer proof pack are ready. Sam will send Carol Tallon the Bridgewater-introduction acceptance, then the next research lane is a qualified developer queue built around named handover, customer-care or delivery owners rather than generic volume outreach. Developer handover and aftercare remains primary. DTC stays payment-gated and Care stays a bounded buyer-discovery lane until a real installer confirms willingness to pay. Revenue and independent customer proof are the unlocks for Enterprise Ireland credibility and a rational full-time funding route. See [[briefs/2026-08-04-tuesday-founder-regroup]], [[items/oh-bridgewater-warm-introduction]] and [[briefs/2026-08-03-openhouse-accelerator-waiting-period-plan]].
