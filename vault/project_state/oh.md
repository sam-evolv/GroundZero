...
**YC and NDRC status, 2026-07-29:** OpenHouse is Sam's first YC application and the only company he has considered applying with. He is fully committed to going full-time and is open to relocating to San Francisco if accepted. The NDRC pre-accelerator interview is scheduled for 29 July 2026; NDRC has not offered funding, requested equity or created a commitment. OpenHouse has €0 revenue, no outside investment and approximately €10,000 of founder funding.
