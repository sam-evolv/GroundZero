...
- Execute the corrected founder-sales reset across remaining credible Irish routes and parallel UK/US prospecting. Reuse the verified proof and rapid-onboarding materials where relevant, but do not treat Bridgewater, Cairn, Glenveagh or O'Flynn as active pipeline without a materially new route. See [[briefs/2026-08-05-openhouse-revenue-first-founder-sales-reset]] and [[briefs/2026-08-04-openhouse-qualified-developer-outreach-queue]].
