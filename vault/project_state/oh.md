...
**Care authentication hardening, 2026-08-01:** Migration 077 and the local distributed limiter proof pass. Multi-home selection, hidden demo/admin removal and exact-installation authority reached independent PASS, after which Sam explicitly authorized a dedicated controlled test relationship and an isolated immutable preview without alias movement. A separate controlled auth identity and clearly synthetic active installation were created under the internal OpenHouse tenant without changing customer records. Controlled testing and exact reviews exposed and fixed a content schema mismatch, open redirect, duplicated tab state, binary system-family fallbacks, nullable heat-pump defaults, CO2 extrapolation, fabricated document/grant UI, and service/conversation database failures misrepresented as empty or silently unsaved. Shared classification and tab state now govern the UI; sparse measurements remain unavailable; all chat history and persistence operations check errors. The controlled operational matrix was rerun after persistence hardening and passed; cleanup removed 2 messages, 1 conversation and 1 request, with zero marked records or known limiter keys remaining. The current clean 43-file commit is `474562be3d5b722b5258f21207b1ec79f349fc56`, patch SHA-256 `562666a9f53e7a568c5d5464cac44cc7a131d79a6e1449145a3e8ab51ae4a6cb`; four smokes, TypeScript, production build, persistence regressions, diff check and secret scan pass, with final review `deleg_c053bba2` pending before preview deployment. Nothing was pushed, merged, deployed or aliased; YC reviewer production remains unchanged. See [[briefs/2026-08-01-openhouse-care-password-and-authority-hardening]].
