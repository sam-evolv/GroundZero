...
**Commercial focus, 2026-08-05:** Sam has explicitly reset OpenHouse around founder-led revenue rather than speculative product work. Bridgewater remains the first priority, followed by the existing Irish warm routes and ranked cold queue, with a bounded UK lane added rather than abandoning Ireland after two large-company outcomes. The 30-day proof target remains two developer conversations, one one-scheme proposal and one paid pilot, signed commitment or decision-changing rejection. Broad US cold outreach and unrelated feature work remain out of scope until a specific buyer route or paid requirement exists. See [[briefs/2026-08-05-openhouse-revenue-first-founder-sales-reset]].

**Commercial focus, 2026-08-04:** Carol Tallon introduced Sam to David at Bridgewater, confirmed she had spoken to both about each other and sent David the OpenHouse interview, and Sam replied proposing a call or meeting. The site and verified Longview developer proof pack are ready. The active priority is preparing a discovery-led Bridgewater conversation around homeowner handover and aftercare, with one concrete next step rather than a generic product tour. A concierge rapid-start pack now reduces the initial ask to one scheme, one operational owner, a clean unit list and an approved document folder. The first deliverable is one validated test home without real homeowner data. Meeting scheduling details are not yet captured. See [[briefs/2026-08-04-bridgewater-meeting-preparation]], [[briefs/2026-08-04-openhouse-rapid-onboarding-runbook]], [[items/oh-bridgewater-warm-introduction]], [[items/oh-bridgewater-rapid-onboarding]] and [[briefs/2026-08-03-openhouse-accelerator-waiting-period-plan]].

**Commercial research checkpoint, 2026-08-04:** The developer queue is now split into warm/direct routes (Bridgewater, Evara, Glenveagh, Cairn and Sean Gallagher) and a ranked cold pilot queue led by Richmond Homes, McGarrell Reilly, Lioncor, O'Flynn Group and Park Developments. Care remains HOLD on build and GO only on five installer-process interviews followed by a €500 prepaid 30-day concierge pilot; one payment is the minimum build signal. DTC should validate a €79 Upgrade Ready Plan before any €5/month subscription thesis. See [[briefs/2026-08-04-openhouse-qualified-developer-outreach-queue]], [[briefs/2026-08-04-openhouse-care-installer-paid-validation]] and [[briefs/2026-08-04-openhouse-dtc-upgrade-ready-plan-validation]].
