...
**Care authentication hardening, 2026-08-01:** The exact 36-file staged code candidate has an independent PASS at canonical diff SHA-256 `de71c377f12c306d8bcb21da215620f8762b305c52e764d3ddd139b11f3ce271`. Sam explicitly approved migration 077 at checksum `32c76592082716231dfa9d2958779b9a1ece1dd785a68d7e0f1726f6cc14b3de`; the full transaction committed successfully and live ownership, forced RLS, privilege, schema and index postconditions passed. The local production build, using its real `SUPABASE_DB_URL` role against the live database, executed the atomic limiter; a route probe returned generic `401` for attempts 1–10 then `429` with `Retry-After` on attempt 11, and all synthetic counter rows were removed. Routine Care uses Supabase email/password with exact-installation authority; unsupported handover access, legacy mutation and unfinished public uploads remain disabled; fabricated operational claims fail closed. Release remains blocked on repeating the limiter proof through an explicitly authorized serverless candidate plus controlled active-account login, recovery, logout/copied-URL and authenticated foreign-installation denial. Nothing was committed, pushed, merged or deployed; the YC reviewer deployment and credentials remain unchanged. See [[briefs/2026-08-01-openhouse-care-password-and-authority-hardening]].
