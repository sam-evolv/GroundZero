...
valid: true
updated_at: "2026-08-01T13:32:26+01:00"
role: project-state
---
...
**Care authentication hardening, 2026-08-01:** Migration 077 and the local distributed limiter proof pass. Multi-home selection, hidden demo/admin removal and exact-installation authority reached independent PASS, after which Sam explicitly authorized a dedicated controlled test relationship and an isolated immutable preview without alias movement. A separate controlled auth identity and clearly synthetic active installation were created under the internal OpenHouse tenant without changing customer records. Controlled local testing and exact review exposed and fixed a content API production-column mismatch, authenticated middleware open redirect, duplicated tab state, binary system-family fallbacks, nullable heat-pump readings represented as zero/default values, CO2 extrapolation, and fabricated pending-document/grant-timeline UI. Page, Home, Assistant and Profile now share one tested heat-pump/solar/unknown classifier; provider owns the sole visible tab state; sparse measurements remain unavailable. The controlled read and operational matrices pass login, exact-home access, foreign denial, assistant, pending service request, alert dismissal, logout and post-logout denial; marked records and limiter buckets were cleaned. The current clean 42-file commit is `0e9a4cb45a3ee70a6c33077a6794439a9726083c`, patch SHA-256 `68dc9b87e55d89d75377f355eecd62be5a1c84ad0659becef21dae844cedc843`; four smokes, TypeScript, production build, classifier/navigation/nullable-metric regressions, diff check and secret scan pass, with final review `deleg_b95e2b94` pending before preview deployment. Nothing was pushed, merged, deployed or aliased; YC reviewer production remains unchanged. See [[briefs/2026-08-01-openhouse-care-password-and-authority-hardening]].
